...
srun -n $SLURM_NTASKS /group/askap/athomson/repos/spiceracs/scripts/casda_prepare.py $data_dir $polcat $prep_type --convert-spectra --convert-cubes --convert-plots -v --mpi --batch_size 10_000
