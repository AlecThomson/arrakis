...
columns = [
    ...
    ('total_flux_sourcefinder', float, 'cat', 'Total_flux_Component', 1e-3*u.Jy),
    ('e_total_flux_sourcefinder', float, 'cat',
     'E_Total_flux_Component', 1e-3*u.Jy),
...
sourcefinder_columns = ('Component_ID',
                        'Source_ID',
                        'Tile_ID',
                        'SBID',
                        'Obs_Start_Time',
                        ...
                        #'E_RA',
                        #'E_Dec',
                        #'Total_flux_Component',
                        #'E_Total_flux_Component',
                        'Total_flux_Source',
                        'E_Total_flux_Source',
                        #'Peak_flux',
                        #'E_Peak_flux',
